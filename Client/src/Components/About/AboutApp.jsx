...
export default function AboutApp() {
  ...
  return (
    <div className="relative h-full">
      {/* ────────────── 🏷️ Sticky Header ────────────── */}
      <div className="sticky top-0 px-6 pt-4 z-20 bg-base-200 rounded-t-xl">
        <h1 className="text-xl card-title py-2">About the App</h1>
        {/* 🔽 Smooth fade at top for scroll transition */}
        <div className="pointer-events-none absolute left-0 right-0 h-6 bg-gradient-to-b from-base-200 to-transparent" />
      </div>
      ...
      >
        ...
        <div className="flex gap-1 items-center justify-end">
          ...
          <h1
            className={`
              text-xl font-bold tracking-wide myfont-kaushan
        ...
        {/* ────────────── 🔖 Version & Tagline ────────────── */}
        <p className="text-zinc-500 text-right">Version: {appInfo.version}</p>
        <p className="text-zinc-400 myfont-AU-NSW font-extralight text-right mb-4">
          "{appInfo.tagline}"
        </p>
        ...
        <p
          className={`
            mb-2 whitespace-pre-line font-[Comfortaa] leading-relaxed text-justify
      ...
      {/* ────────────── ⬆️ Bottom Fade ────────────── */}
      <div className="sticky bottom-0 pt-4 bg-base-200 rounded-b-xl">
        {/* Smooth fade at bottom for scroll ending */}
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 w-full h-10 bg-gradient-to-t from-base-200 to-transparent rounded-b-xl" />
      </div>
