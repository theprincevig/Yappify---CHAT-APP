...
const AppError = require("./errors/AppError.js"); // Custom error handler
...
// Routers
const authRouter = require("./routes/user.routes.js"); // Auth routes
const profileRouter = require("./routes/profile.routes.js"); // Profile routes
const messageRouter = require("./routes/message.routes.js"); // Chat message routes
const friendRouter = require("./routes/friend.routes.js"); // Friend system routes
...
app.all("/files{/*path}", (req, res, next) => {
  next(new AppError(404, "Page not found!")); // Custom 404 error
});
